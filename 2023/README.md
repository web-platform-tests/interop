...
- There are two kinds of proposals:
  ...
  - **Investigation Effort**: In cases where there aren't high quality specifications and tests, an investigation effort may be appropriate. An investigation efforts consists of a set of tasks that will bring the feature up to the bar required for a Focus Area in the future. If this involves any standards work, that work must be done in the appropriate standards group, and those doing the work need to join those groups.
